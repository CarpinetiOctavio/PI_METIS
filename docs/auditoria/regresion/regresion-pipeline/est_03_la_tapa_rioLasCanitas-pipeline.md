...
|----------|-------|
| n | 41 |
| Media [m³/s] | 62.390243902439025 |
| Mediana [m³/s] | 42.0 |
| Varianza (no sesgada) [m³/s]² | 5963.693902439025 |
| Varianza (sesgada) [m³/s]² | 5818.2379535990485 |
| Desvío [m³/s] | 77.22495647418019 |
| Asimetría Sesgada | 3.0525681913567717 |
| Asimetría No Sesgada (g) | 3.289337903635085 |
| Curtosis Sesgada | 12.681315379907263 |
| Curtosis No Sesgada (k) | 14.743740507735971 |
| Coeficiente de Variación (CV) | 1.2377729536518325 |
| Sumatoria ln(xi) | 149.22825284339663 |
| beta_0 = M0 | 62.390243902439025 |
| beta_1 = M1 | 47.2280487804878 |
| beta_2 = M2 | 39.51250781738587 |
| beta_3 = M3 | 34.7065024192752 |
| Máximo [m³/s] | 402.0 |
| Mínimo [m³/s] | 2.0 |
| Rango [m³/s] | 400.0 |
...
|-----------|-------|
| Estadístico (S-C) | 6.0 |
| Valor crítico (± lim) | 6.324555320336759 |
| Veredicto | aprobada |
| Warning | None |
...
| Parámetro | Valor |
|-----------|-------|
| Estadístico t | 1.8751356989615136 |
| n1 | 20 |
| n2 | 21 |
| Valor crítico (tabla) | 2.0226909200367604 |
| Veredicto | aprobada |

#### Cramer
| Parámetro | Valor |
|-----------|-------|
| Estadístico (t_w1) | 0.9860578672952841 |
| n_w1 | 25 |
| n_w2 | 12 |
| Valor crítico (tabla) | 2.0226909200367604 |
| Veredicto | aprobada |
...
| Parámetro | Valor |
|-----------|-------|
| Estadístico (máx r_k) | 0.34419254763913526 |
| Valor crítico | 0.28099927900963967 |
| Veredicto | aprobada |

#### Wald-Wolfowitz
| Parámetro | Valor |
|-----------|-------|
| Estadístico Z | 0.3661123907560356 |
...
| Parámetro | Valor |
|-----------|-------|
| Estadístico | -0.7867486450323444 |
...
| Parámetro | Valor |
|-----------|-------|
| Estadístico (Z tipificado) | 0.9601829094043463 |
| Valor crítico | 1.358 |
| Veredicto | aprobada |
...
| Parámetro | Valor |
|-----------|-------|
| Estadístico (máx Z_i) | 2.8095562084179027 |
| Valor crítico (K_N) | 2.8776635330783646 |
| Veredicto | aprobada |

**Veredicto general Etapa 1 (pipeline):** nivel_confianza=`validado` — warnings: ninguno
...
|---|---|---|---|---|---|---|
| Uniforme | Momentos | alfa = -71.3673 | beta = 196.1478 |  | 59.1524 | ok |
| Uniforme | Máxima Verosimilitud | alfa = 2.0000 | beta = 402.0000 |  | 164.6652 | ok |
| Exponencial beta | Momentos | beta = 0.016028 |  |  | 35.1081 | ok |
| Exponencial beta | Máxima Verosimilitud | beta = 0.016028 |  |  | 35.1081 | ok |
| Exponencial x0 y beta | Momentos | x0 = -14.8347 | beta = 77.2250 |  | 31.8239 | ok |
| Exponencial x0 y beta | Máxima Verosimilitud | x0 = 0.490244 | beta = 61.9000 |  | 35.7549 | ok |
| Generalizada Exponencial | Momentos | alfa = 0.624618 | lambda = 0.011607 |  | 28.7394 | ok |
| Generalizada Exponencial | Máxima Verosimilitud | alfa = 1.2189 | lambda = 0.018237 |  | 38.5855 | ok |
| Generalizada Exponencial | Momentos L | alfa = 0.246476 | lambda = -0.012965 |  | 147.1598 | ok |
| Normal | Momentos | mu = 62.3902 | sigma = 77.2250 |  | 51.6622 | ok |
| Normal | Máxima Verosimilitud | mu = 62.3902 | sigma = 77.2250 |  | 51.6622 | ok |
| Normal | Momentos L | mu = 62.3902 | sigma = 56.8207 |  | 50.4332 | ok |
| Log Normal (2 parámetros) | Momentos | mu_y = 3.6397 | sigma_y = 1.0488 |  | 23.3473 | ok |
| Log Normal (2 parámetros) | Máxima Verosimilitud | mu_y = 3.6397 | sigma_y = 1.0488 |  | 23.3473 | ok |
| Log Normal (3 parámetros) | Momentos | x0 = -25.9734 | mu_y = 4.1977 | sigma_y = 0.753299 | 30.3361 | ok |
| Log Normal (3 parámetros) | Máxima Verosimilitud | x0 = -3.8932 | mu_y = 3.7935 | sigma_y = 0.870277 | 33.5550 | ok |
| Gamma (2 parámetros) | Momentos | alfa = 95.5870 | beta = 0.652707 |  | 28.8459 | ok |
| Gamma (2 parámetros) | Máxima Verosimilitud | alfa = 53.8555 | beta = 1.1585 |  | 38.2353 | ok |
| Gamma (2 parámetros) | Momentos L | alfa = 67.0473 | beta = 0.930541 |  | 34.5658 | ok |
| Gamma (3 parámetros) | Momentos |  |  |  | — | no_aplicable |
| Gamma (3 parámetros) | Máxima Verosimilitud |  |  |  | — | no_converge |
| Gumbel | Momentos | mu = 27.6390 | alfa = 60.2355 |  | 39.8075 | ok |
| Gumbel | Máxima Verosimilitud | mu = 36.9134 | alfa = 35.3998 |  | 47.7771 | ok |
| Gumbel | Momentos L | mu = 35.6875 | alfa = 46.2612 |  | 41.7918 | ok |
| Gumbel | Máxima Entropía | mu = 38.4601 | alfa = 41.4578 |  | 43.8896 | ok |
| GVE (Valores Extremos) | Momentos | nu = 540.3436 | alfa = 42.8784 | beta = -0.193512 | 529.6995 | ok |
| GVE (Valores Extremos) | Máxima Verosimilitud | nu = 29.9172 | alfa = 25.6938 | beta = -0.417008 | 31.6660 | ok |
| GVE (Valores Extremos) | Momentos L | nu = 28.9209 | alfa = 23.9004 | beta = -0.459604 | 31.0467 | ok |
| Log Pearson tipo III | Momentos Método Directo |  |  |  | — | no_aplicable |
| Log Pearson tipo III | Momentos Método Indirecto | alfa = 0.269965 | beta = 15.0918 | y0 = -0.434551 | 13.5944 | ok |
| Log Pearson tipo III | Máxima Verosimilitud |  |  |  | — | no_converge |
| Generalizada de Pareto | Momentos | mu = -3.4114 | sigma = 56.7879 | epsilon = -0.136982 | 49.7452 | ok |
| Generalizada de Pareto | Máxima Verosimilitud |  |  |  | — | no_converge |
| Generalizada de Pareto | Mínimos Cuadrados | mu = 1.9984 | sigma = 32.4293 | epsilon = -0.46862 | 78.0633 | ok |
| Generalizada de Pareto | Momento Prob. Pesada | mu = -20.2469 | sigma = 1,004.3911 | epsilon = 4.1475 | 212,491,390.2563 | ok |

### Notas de cableado — Bloque 6/7 (solo señalamiento, sin investigar causa)

**¿Ceros en la serie?** No — mínimo observado = 2.0 (`tiene_ceros=False` pasado a `ejecutar_etapa2()`). La rama `STATUS_DISABLED_ZEROS` no se ejercita en ninguna de las 4 estaciones auditadas hasta ahora (est_02, est_03, est_05, est_06) — sigue sin verificar en el pipeline real.

**Cambios de status vs. est_02** (comparando categoría, no valor numérico):
- `gen_pareto/mc`: est_02=`no_converge` -> est_03=`ok`
- `logpearson3/mv`: est_02=`ok` -> est_03=`no_converge`
- `gamma3p/momentos`: est_02=`ok` -> est_03=`no_aplicable`

**GVE / MV — rama de inicialización:**
- Descartada (guard IV-202 falla con nu0=540.3436, alpha0=42.8784, beta0 derivado de g). Fallback activo: Momentos-L (ML) como condición inicial para MV.